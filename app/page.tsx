    ...
    <main id="top">
      ...
      <section className="hero heroSlider" onWheel={(event) => { if (Math.abs(event.deltaY) > 45) goToSlide(slide + (event.deltaY > 0 ? 1 : -1)); }}>
        ...
        <div className="heroContent slideIn" key={slide}>
          ...
          <div className="heroActions"><a className="primary btn-magnetic" href="#properties">Explore properties <ArrowRight size={17} /></a><a className="secondary" href={wa} target="_blank" rel="noopener noreferrer">WhatsApp us</a></div>
